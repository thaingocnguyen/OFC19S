...
namespace SolarQuest
{
    public class SolarQuestIntroductionBox : SolarInfoBox
    {
        ...
        {
            sentences.Enqueue("Hello there! My name is Renee.");
            sentences.Enqueue("They call me 'Renewable Renee' because I believe we can get the biggest impact on adapting to & mitigating climate change by altering where we get our energy from - which means more renewable energy and no reliance on fossil fuels.");
            ...
            sentences.Enqueue("Do you know about Vancouver's Renewable City Strategy (RCS) where the city has set an ambitious emission reduction target? The RCS proposes 80% reduction in GHG emissions and a shift to derive 100% of its energy from renewable sources by the year 2050.");
