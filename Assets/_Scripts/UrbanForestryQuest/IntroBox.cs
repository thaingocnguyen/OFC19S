...
namespace UrbanForestryQuest
{
    public class IntroBox : InfoBox
    {
        ...
        private void Start()
        {
            ...
            sentences.Enqueue("Do you know about Vancouver's Urban Forest Strategy where the city has set an ambitious target of increasing its tree canopy to 22% by 2050? How do we get there? By planting 150,000 new trees! And all of us can do a lot to support this transition through better management, replanting, and stewardship of trees in public and private land.");
